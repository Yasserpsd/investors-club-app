  ...
  Future<void> _handleSignUp() async {
    ...
    if (!_agreedToTerms) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('يجب الموافقة على الضوابط والأحكام',
  ...
  void _showTermsDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('الضوابط والأحكام',
            style: TextStyle(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              _termItem(
                  '1', 'العضوية في نادي المستثمرين متاحة لجميع المهتمين بالاستثمار.'),
              _termItem('2', 'يلتزم العضو بصحة البيانات المدخلة عند التسجيل.'),
              _termItem(
                  '3', 'لا يحق للعضو مشاركة بيانات الدخول مع أي طرف آخر.'),
              _termItem('4',
                  'الفرص الاستثمارية المعروضة هي للاطلاع وليست توصية مالية.'),
              _termItem(
                  '5', 'يتحمل العضو مسؤولية قراراته الاستثمارية بالكامل.'),
              _termItem(
                  '6', 'النادي غير مسؤول عن أي خسائر مالية ناتجة عن الاستثمار.'),
              _termItem('7',
                  'يحق للإدارة تعليق أو إلغاء العضوية في حال مخالفة الشروط.'),
              ...
              _termItem(
                  '12', 'بالتسجيل يوافق العضو على جميع الشروط أعلاه.'),
            ],
          ),
        ),
        actions: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        RadioListTile<String>(
                            ...
                            title: Text('ملاءتي المالية متوسطة',
                                style: TextStyle(
                                    fontFamily: 'IBMPlexSansArabic',
                                    fontSize: 13,
                        ...
                        RadioListTile<String>(
                            ...
                            onChanged: (v) =>
                                setState(() => _financialCapacity = v!),
                            title: Text('ملاءتي المالية عالية (VIP)',
                                style: TextStyle(
                                    fontFamily: 'IBMPlexSansArabic',
                                    fontSize: 13,
                                    color: Colors.white.withOpacity(0.7))),
